...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see ${package}.service.impl.PasswordTokenManager${symbol_pound}generateRecoveryToken(${package}.model.User)
     */
    @Override
    ...
    /**
     * @see ${package}.service.impl.PasswordTokenManager${symbol_pound}isRecoveryTokenValid(${package}.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see ${package}.service.impl.PasswordTokenManager${symbol_pound}invalidateRecoveryToken(User, String)
     */
    @Override
