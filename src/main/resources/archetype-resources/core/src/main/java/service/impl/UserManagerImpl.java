...
import ${package}.service.MailEngine;
import ${package}.service.UserExistsException;
 ...
 */
@Service("userManager")
@WebService(serviceName = "UserService", endpointInterface = "${package}.service.UserService")
public class UserManagerImpl extends GenericManagerImpl<User, Long> implements UserManager, UserService {
     ...
     * @see ${package}.service.MailEngine${symbol_pound}sendMessage(org.springframework.mail.SimpleMailMessage, String, java.util.Map)
     */
