...
import ${package}.service.LookupManager;
...
public class StartupListener implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent event) {
        ...
        try {
            ProviderManager provider = (ProviderManager) ctx.getBean("org.springframework.security.authentication.ProviderManager${symbol_pound}0");
    ...
    public void contextDestroyed(ServletContextEvent servletContextEvent) {
        ...
        //WARN: The method class org.apache.commons.logging.impl.SLF4JLogFactory${symbol_pound}release() was invoked.
