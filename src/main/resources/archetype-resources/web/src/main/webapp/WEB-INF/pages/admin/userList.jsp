...
<div class="col-sm-10">
    ...
    <form method="get" action="${symbol_dollar}{ctx}/admin/users" id="searchForm" class="form-inline">
    <div id="search" class="text-right">
        <span class="col-sm-9">
            <input type="text" size="20" name="q" id="query" value="${symbol_dollar}{param.q}"
