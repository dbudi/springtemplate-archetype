...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see it.pkg.service.impl.PasswordTokenManager#generateRecoveryToken(it.pkg.model.User)
     */
    @Override
    ...
    /**
     * @see it.pkg.service.impl.PasswordTokenManager#isRecoveryTokenValid(it.pkg.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see it.pkg.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
