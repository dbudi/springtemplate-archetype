...
import it.pkg.dao.UserDao;
import it.pkg.model.User;
import it.pkg.service.MailEngine;
import it.pkg.service.UserExistsException;
import it.pkg.service.UserManager;
 ...
 */
@Service("userManager")
@WebService(serviceName = "UserService", endpointInterface = "it.pkg.service.UserService")
public class UserManagerImpl extends GenericManagerImpl<User, Long> implements UserManager, UserService {
     ...
     * @see it.pkg.service.MailEngine#sendMessage(org.springframework.mail.SimpleMailMessage, String, java.util.Map)
     */
