package it.pkg.dao.jpa;

import org.apache.commons.logging.Log;
import org.apache.commons.logging.LogFactory;
import it.pkg.dao.GenericDao;
import it.pkg.dao.SearchException;
 ...
 * <pre>
 *      &lt;bean id="fooDao" class="it.pkg.dao.hibernate.GenericDaoJpaHibernate"&gt;
 *          &lt;constructor-arg value="it.pkg.model.Foo"/&gt;
...
public class GenericDaoJpa<T, PK extends Serializable> implements GenericDao<T, PK> {
    ...
    public T get(PK id) {
        ...
        if (entity == null) {
            String msg = "ups sorry, '" + this.persistentClass + "' object with id '" + id + "' not found...";
            log.warn(msg);
