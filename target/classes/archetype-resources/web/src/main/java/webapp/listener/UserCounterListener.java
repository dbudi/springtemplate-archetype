...
public class UserCounterListener implements ServletContextListener, HttpSessionAttributeListener, HttpSessionListener {
     ...
     * @see javax.servlet.http.HttpSessionAttributeListener${symbol_pound}attributeAdded(javax.servlet.http.HttpSessionBindingEvent)
     */
     ...
     * @see javax.servlet.http.HttpSessionAttributeListener${symbol_pound}attributeRemoved(javax.servlet.http.HttpSessionBindingEvent)
     */
     ...
     *
     * @param event the session binding event
     * @see javax.servlet.http.HttpSessionAttributeListener${symbol_pound}attributeReplaced(javax.servlet.http.HttpSessionBindingEvent)
     */
