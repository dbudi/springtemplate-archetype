...
import ${package}.webapp.listener.StartupListener;
...
public class ReloadController {
    ...
    throws Exception {
        ...
        if (referer != null) {
            ...
            out.println("</head>");
            out.println("<body bgcolor=${symbol_escape}"white${symbol_escape}">");
            out.println("<script type=${symbol_escape}"text/javascript${symbol_escape}">");
